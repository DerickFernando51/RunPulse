...
#define CFG_IDENTITY_ADDRESS              CFG_ADV_BD_ADDRESS

#define CFG_FAST_CONN_ADV_INTERVAL_MIN    (0x80)
#define CFG_FAST_CONN_ADV_INTERVAL_MAX    (0xA0)

#define CFG_PRIVACY 0
...
#define CFG_IDLEEVT_HCI_CMD_EVT_RSP_ID      0

#define CFG_LAST_TASK_ID_WITH_HCICMD        CFG_TASK_HCI_ASYNCH_EVT_ID
